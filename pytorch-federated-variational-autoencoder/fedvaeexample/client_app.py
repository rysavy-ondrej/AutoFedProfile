...
#         "/workspace/pytorch-federated-variational-autoencoder/desktop_normalized_20250417_144736.npy",
#         target_column=None,  # Use last column as target, or set to None if all columns are features
